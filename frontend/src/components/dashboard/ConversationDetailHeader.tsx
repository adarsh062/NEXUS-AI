...
import { ArrowLeft, MoreVertical, Bot, Trash2, CheckCircle, Ban, Sparkles } from "lucide-react"
            ...
            <div className="flex items-center gap-3 px-3 h-14 border-b shrink-0 bg-background">
                ...
                >
                    ...
                    <div className="min-w-0">
                        ...
                        {/* Custom status (Feature 3) takes priority over last-seen */}
                        {receiver?.statusText || receiver?.statusEmoji ? (
                            <p className="text-xs text-primary/80 italic leading-tight truncate">
                                {receiver.statusEmoji} {receiver.statusText}
                            </p>
                        ) : (
                ...
                <Button
                    ...
                    size="icon"
                    className={cn(
                        "shrink-0 relative transition-all duration-200 rounded-full",
                        aiPanelOpen ? "text-primary bg-primary/10 border border-primary/20" : "text-muted-foreground hover:text-primary hover:bg-primary/5"
                    )}
                ...
                <DialogContent className="sm:max-w-sm">
                    ...
                    <div className="flex flex-col items-center gap-4 pt-2">
                        ...
                        <div className="text-center space-y-1">
                            ...
                            {(receiver?.statusText || receiver?.statusEmoji) ? (
                                <p className="text-sm text-primary/80 italic">{receiver.statusEmoji} {receiver.statusText}</p>
                            ) : (
